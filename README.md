...
- Android Kotlin app with Retrofit sync, Room cache, local ZIP extraction, local sticker preview, role-aware image uploads, rotate/crop/pan/zoom editing, and WhatsApp import intent.
